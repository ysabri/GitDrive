...
import { AppFileStatus, CommittedFileChange } from "../../model/git/status";
...
export async function getCommits(
  ...
  // really nice command here:
  // "git log HEAD --date=raw --max-count=1
  // --pretty='%H%x1F%s%x1F%b%x1F%an <%ae> %ad%x1F%P' -z --no-color --"
