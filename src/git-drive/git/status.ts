...
import { DiffSelection, DiffSelectionType } from "models/git/diff";
...
import { fatalError } from "utils/errors-util";
import { mapStatus, parsePorcelainStatus } from "utils/status-parser";
