...
// at this link:
// https://github.com/desktop/desktop/blob/master/app/src/lib/api.ts
...
// TODO: change this, this is used for a 2 factor auth bellow.
const username: string = "TestUser";
// const username: () => Promise<string> = require('username');

const ClientID = process.env.TEST_ENV ? "'" : "77ab401b60a888684dcb";
const ClientSecret = process.env.TEST_ENV ? "" : "e067207f25e4a0df1036a4bd1555af23f71a002a";
